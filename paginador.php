<!DOCTYPE html>
<!--ref. https://codepen.io/tutsplus/pen/RmGKyR -->
<html lang="es">
<head>
  <title>Bootstrap 5 pager</title>
  <meta charset="utf-8">
...
<script>
	...
	const myPager = $('#myPager');
	
	
	for (var i = 0; i < pageCount; i++) {
	
		myPager.append('<li class="page-item"><a class="page-link" href="#">'+ (i+1) + '</a></li>');
	}
	
	displayRows(1);
	
	$('#myPager li a').click(function(e) {
		var $this = $(this);
...
<body>
	<div class="container-fluid">
		...
		<div class="container mt-3">
		  <ul class="pagination justify-content-center" id="myPager">
